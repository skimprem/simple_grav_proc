...
def get_vg(readings, max_degree=2, vg_max_degree=2):
    ...
    for meter_survey, grouped_by_meter in group_by_meter_and_survey:
        ...
        # ones = np.ones(shape=(gravity.size, 1))
        ...
        result = model.fit() 
        coefs = result.params[:vg_max_degree]
        std_coefs = result.bse[:vg_max_degree]
        ...
        vg_dict['resid'].append(result.resid)
